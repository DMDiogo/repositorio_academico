        ...
        <form action="{{ route('publications.update', $publication) }}" method="POST" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200 p-6">
            ...
            <div class="space-y-8 divide-y divide-gray-200">
                <div>
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <!-- Arquivo -->
                        <div class="sm:col-span-6">
                            <label for="file" class="block text-sm font-medium text-gray-700">Arquivo (PDF, DOC, DOCX) - opcional</label>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500">Arquivo atual: {{ $publication->original_filename }}</p>
                                </div>
                            </div>
                            @error('file')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
            ...
            <div class="pt-5">
                <div class="flex justify-end">
                    <a href="{{ route('publications.my-publications') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Cancelar
                    </a>
