    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        ...
        <div class="mt-4 md:mt-0 flex items-center space-x-4">
            @if(auth()->check() && auth()->user()->user_type === 'teacher')
                <a href="{{ route('publications.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <div class="relative rounded-md shadow-sm max-w-xs">
                <input type="text" 
                       ...
                       form="filterForm"
                       class="block w-full rounded-md border-0 py-3 pl-4 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm" 
