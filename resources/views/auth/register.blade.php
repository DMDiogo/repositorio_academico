            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ url('/register') }}" class="space-y-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="text-gray-600">
                                Eu concordo com os <a href="#" class="text-blue-600 hover:text-blue-800 underline">Termos de Serviço</a> e <a href="#" class="text-blue-600 hover:text-blue-800 underline">Política de Privacidade</a>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <div>
                            <a href="{{ url('/login') }}" class="text-sm text-blue-600 hover:text-blue-800 underline transition duration-150 ease-in-out">
                                Já tem uma conta?
                            </a>
                        </div>
                ...
                <!-- Divisor com opção para registro social -->
                <div class="mt-8">
                    <div class="relative">
