            ...
            <div class="p-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <a href="#" class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-6 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <li class="px-6 py-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-4 flex-shrink-0 flex space-x-2">
                                        ...
                                        <form action="{{ route('users.reject', $user) }}" method="POST" class="inline" onsubmit="return confirmReject(this)">
                                            @csrf
