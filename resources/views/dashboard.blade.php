        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ Auth::user()->isTeacher() ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                            {{ Auth::user()->isTeacher() ? 'Professor' : 'Aluno' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <a href="{{ route('publications.my-publications') }}" class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-6 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            ...
                            <span class="mt-1 block text-sm text-gray-500">Gerencie suas publicações existentes</span>
                        </a>
                                ...
                                <div class="flex items-center">
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-sm text-gray-500">
                                            Você criou sua conta com sucesso como {{ Auth::user()->isTeacher() ? 'professor' : 'aluno' }}. Comece adicionando suas publicações acadêmicas para compartilhar com a comunidade.
                                        </p>
                                    </div>
